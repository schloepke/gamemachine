...

{
	...
	public static EntityList fromModel(Model model) {
...
public byte[] toPrefixedByteArray() {
  ...
  Schema<EntityList> schema = RuntimeSchema.getSchema(EntityList.class);
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, RuntimeSchema.getSchema(EntityList.class));
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed");
	}
