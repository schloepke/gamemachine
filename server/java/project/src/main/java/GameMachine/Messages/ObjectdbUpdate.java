...
public byte[] toPrefixedByteArray() {
  ...
  Schema<ObjectdbUpdate> schema = RuntimeSchema.getSchema(ObjectdbUpdate.class);
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, RuntimeSchema.getSchema(ObjectdbUpdate.class));
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed");
	}
