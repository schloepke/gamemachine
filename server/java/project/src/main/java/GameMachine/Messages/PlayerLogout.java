...

{
	...
	public void toModel(Model model, String playerId) {
    	...
    	if (authtoken != null) {
    		model.setString("player_logout_authtoken",authtoken);
    	}
	...
	public static PlayerLogout fromModel(Model model) {
    	...
    	String authtokenField = model.getString("player_logout_authtoken");
...
public static PlayerLogout parseFrom(byte[] bytes) {
	PlayerLogout message = new PlayerLogout();
	ProtobufIOUtil.mergeFrom(bytes, message, RuntimeSchema.getSchema(PlayerLogout.class));
	return message;
}
...
public byte[] toPrefixedByteArray() {
  ...
  Schema<PlayerLogout> schema = RuntimeSchema.getSchema(PlayerLogout.class);
...
public byte[] toProtobuf() {
	...
	try {
		bytes = ProtobufIOUtil.toByteArray(this, RuntimeSchema.getSchema(PlayerLogout.class), buffer);
		buffer.clear();
	} catch (Exception e) {
		e.printStackTrace();
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, RuntimeSchema.getSchema(PlayerLogout.class));
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed");
	}
