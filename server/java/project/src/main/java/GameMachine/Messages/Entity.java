...

{
	...
	public void dbPut() {
		DatastoreCommands.put(this);
	}
	
	public static void dbDelete(String entityId) {
		DatastoreCommands.delete(entityId);
	}
		
	public static Entity dbGet(String entityId, int timeout) {
		return DatastoreCommands.get(entityId, timeout);
	}
    ...
    public void writeTo(Output output, Entity message) throws IOException
    {
    	...
    	if(message.trackData != null)
    		output.writeObject(1000, message.trackData, TrackData.getSchema(), false);

    	if(message.gameMessage != null)
    		output.writeObject(1001, message.gameMessage, GameMessage.getSchema(), false);

    	if(message.gameMessages != null)
    		output.writeObject(1002, message.gameMessages, GameMessages.getSchema(), false);

    	if(message.playerItems != null)
    		output.writeObject(1003, message.playerItems, PlayerItems.getSchema(), false);

    	if(message.testObject != null)
    		output.writeObject(1004, message.testObject, TestObject.getSchema(), false);
    ...
    public String getFieldName(int number)
    {
        switch(number)
        {
        	...
        	case 1000: return "trackData";
        	
        	case 1001: return "gameMessage";
        	
        	case 1002: return "gameMessages";
        	
        	case 1003: return "playerItems";
        	
        	case 1004: return "testObject";
    ...
    static
    {
    	...
    	__fieldMap.put("trackData", 1000);
    	
    	__fieldMap.put("gameMessage", 1001);
    	
    	__fieldMap.put("gameMessages", 1002);
    	
    	__fieldMap.put("playerItems", 1003);
    	
    	__fieldMap.put("testObject", 1004);
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, RuntimeSchema.getSchema(Entity.class));
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed");
	}
