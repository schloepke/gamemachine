...
public final class ClientMessage  implements Externalizable, Message<ClientMessage>, Schema<ClientMessage>
{
	...
	public ClientDisconnect getClientDisconnect() {
		return clientDisconnect;
	}
	
	public ClientMessage setClientDisconnect(ClientDisconnect clientDisconnect) {
		this.clientDisconnect = clientDisconnect;
		return this;
	}
	
	public Boolean hasClientDisconnect()  {
        return clientDisconnect == null ? false : true;
    }
        ...
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
            	...
            	case 5:
                	...
                	message.clientDisconnect = input.mergeObject(message.clientDisconnect, ClientDisconnect.getSchema());
                    break;
    ...
    public void writeTo(Output output, ClientMessage message) throws IOException
    {
    	...
    	if(message.clientDisconnect != null)
    		output.writeObject(5, message.clientDisconnect, ClientDisconnect.getSchema(), false);
    	...
    	if(message.playerLogout != null)
    		output.writeObject(6, message.playerLogout, PlayerLogout.getSchema(), false);
    ...
    public String getFieldName(int number)
    {
        switch(number)
        {
        	...
        	case 5: return "clientDisconnect";

        	case 6: return "playerLogout";
    ...
    static
    {
    	...
    	__fieldMap.put("clientDisconnect", 5);

    	__fieldMap.put("playerLogout", 6);
