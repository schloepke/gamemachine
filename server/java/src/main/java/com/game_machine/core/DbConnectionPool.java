...
public class DbConnectionPool {
    ...
    public Boolean connect(String id, String url, String driver, String username, String password) {
    	if (pools.containsKey(id)) {
    		return true;
    	}
    	
    	log.warn("JDBC id:"+id+" url:"+url+" driver:"+driver+" username:"+username+" password:"+password);
    	try {
