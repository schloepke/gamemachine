...
public class StatusEffectDef {
	...
	public static void createStatusEffects() {
		...
		// Passive
		// StatusEffect spellResist =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.SpellResistIncrease, "spell_resist", 30, "passive",
		// 100, 100, null);
		//
		// StatusEffect root = createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.Root, "root", 4,
		// "passive", 100, 100, null);
		//
		// StatusEffect staff = createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.ArmorIncrease, "staff",
		// 120, "passive", 100, 100, null);
		// addSkill("staff", staff);
		//
		// // Active
		// StatusEffect deadlyAttack =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "deadly_attack", 1, "health",
		// 500, 1000, null);
		// StatusEffect cleave =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease,
		...
		// StatusEffect lightningBolt =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "lightning_bolt", 1, "health",
		// 40, 50, "Thunder");
		// StatusEffect healingRing =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeIncrease, "healing_ring", 10, "health",
		// 20, 25, "Eternal Light");
		// StatusEffect fireField =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease,
		// "fire_field", 10, "health", 20, 25, "Eternal Flame");
		// StatusEffect catapultExplosive =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "catapult_explosive", 1,
		// "health", 300, 500, null);
		// StatusEffect ballistaExplosive =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "ballista_explosive", 1,
		// "health", 300, 500, null);
		// StatusEffect speed = createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.Speed, "speed", 1,
		// "stamina", 5, 5, null);
		// StatusEffect lightAttack =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "light_attack", 1, "health", 40,
		// 50, null);
		// StatusEffect meleeAutoAttack =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "melee_auto_attack", 1,
		// "health", 40, 50, null);
		// StatusEffect rangedAutoAttack =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease, "ranged_auto_attack", 1,
		// "health", 40, 50, null);
		// StatusEffect fireAura =
		// createStatusEffect(StatusEffect.DamageType.None,
		// StatusEffect.Type.AttributeDecrease,
