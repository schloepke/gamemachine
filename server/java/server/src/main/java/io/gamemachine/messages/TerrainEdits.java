...
private static final Logger logger = LoggerFactory.getLogger(TerrainEdits.class);
    ...
    static final String defaultScope = TerrainEdits.class.getSimpleName();
	...
	public static TerrainEdits fromModel(Model model) {
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, TerrainEdits.getSchema());
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed "+e.getMessage());
	}
