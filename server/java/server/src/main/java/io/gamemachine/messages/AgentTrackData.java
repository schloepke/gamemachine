...
public final class AgentTrackData implements Externalizable, Message<AgentTrackData>, Schema<AgentTrackData>{
    ...
    static final String defaultScope = AgentTrackData.class.getSimpleName();
    ...
    {
    	System.out.println("START AgentTrackData");
    	    	if(this.trackData != null) {
    		System.out.println("trackData="+this.trackData);
    	}
    	    	System.out.println("END AgentTrackData");
    }
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, AgentTrackData.getSchema());
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed");
	}
