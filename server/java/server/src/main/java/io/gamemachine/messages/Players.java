...
public final class Players implements Externalizable, Message<Players>, Schema<Players>{
    ...
    static final String defaultScope = Players.class.getSimpleName();
	...
	public static Players fromModel(Model model) {
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, Players.getSchema());
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed "+e.getMessage());
	}
