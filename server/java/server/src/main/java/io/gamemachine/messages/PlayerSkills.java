...
private static final Logger logger = LoggerFactory.getLogger(PlayerSkills.class);
    ...
    static final String defaultScope = PlayerSkills.class.getSimpleName();
	...
	public static PlayerSkills fromModel(Model model) {
...
public ByteBuf toByteBuf() {
	...
	try {
		ProtobufIOUtil.writeTo(buffer, this, PlayerSkills.getSchema());
	} catch (Exception e) {
		e.printStackTrace();
		throw new RuntimeException("Protobuf encoding failed "+e.getMessage());
	}
