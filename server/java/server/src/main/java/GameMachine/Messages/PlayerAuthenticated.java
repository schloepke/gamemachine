...
public final class PlayerAuthenticated implements Externalizable, Message<PlayerAuthenticated>, Schema<PlayerAuthenticated>
{
	...
	public void toModel(Model model) {
    	...
    	if (authtoken != null) {
    		model.setString("player_authenticated_authtoken",authtoken);
    	}
	...
	public static PlayerAuthenticated fromModel(Model model) {
    	...
    	String authtokenField = model.getString("player_authenticated_authtoken");
	...
	public PlayerAuthenticated setAuthtoken(String authtoken) {
