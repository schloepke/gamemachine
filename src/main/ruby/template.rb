...
class Template
  def create_components(names)
    ...
    template_file = File.join(user_dir,'src','main','resources','codegen_templates','entities.erb')
    output_file = File.join(user_dir,'src','generated','java','EntitiesHelper.java')
