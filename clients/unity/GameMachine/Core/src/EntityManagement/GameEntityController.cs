...
namespace GameMachine {
    namespace Common {
        public class GameEntityController : MonoBehaviour {
            ...
            private float preleapSpeed;
            GameObject jumpTarget;
            GameObject jumpTargetCore;
            Vector3[] jumpPath;
            int jumpIndex = 0;
            public bool portHome = false;
            ...
            private void SetAnimation(int triggerId) {
                gameEntity.GetAnimationController().RequestAnimation(triggerId);
            }
            ...
            void MyUpdate() {
                ...
                if (grounded) {
                    ...
                    if (gameEntity.IsPlayer()) {
                        //Debug.Log (_move_speed + " " + _t.position + " " + _last_position + " " + (_t.position - _last_position));
                    }
                    lastPosition = transform.position;
