...
public class Object2Terrain : EditorWindow
{
	...
	{
		try {
			return Selection.activeTransform.GetComponent<MeshFilter> ().sharedMesh && Terrain.activeTerrain;
		} catch {
			return false;
		}
	}
	...
	{
		this.Close ();
	}	// Otherwise the object selection could change and that would screw CreateTerrain() up.
