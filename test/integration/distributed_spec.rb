  ...
  describe "basic" do 
    ...
    describe "sending messages to remote actors" do
      it "distributed messaging should return answer" do
         e = entity.clone
        10.times do |i|
          ref = GameSystem::LocalEcho.find_distributed(i.to_s, 'DistributedLocalEcho')
    ...
    describe "stress test" do
      it "distributed stress" do
        e = entity.clone
        measure(10,10000) do
          Thread.current['ref'] ||= GameSystem::LocalEcho.find_distributed(rand(100).to_s,'DistributedLocalEcho')
