...
public class GameActor extends UntypedActor {
	...
	public final void onReceive(Object message) throws Exception {
		if (message instanceof GameMessage) {
			...
			gameMessage = new GameMessage(gatewayMessage.getClientId(),null,entities);
			onReceive(entities);
		} else {
			unhandled(message);
		}
	...
	public void sendToClient(Entity entity) {
		...
		GatewayMessage gatewayMessage = new GatewayMessage(bytes,gameMessage.getClientId());
	...
	public void sendTo(String name, Entity entity) {
		...
		GameMessage message = new GameMessage(gameMessage.getClientId(),entity,gameMessage.getEntities());
